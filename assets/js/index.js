...
//function to update stock market shares
  ...
  function getStockValue(comp_name){
        ...
        stock_string+=`<p>`
        count+=1;
    fetch(`https://api.polygon.io/v2/aggs/ticker/${comp_name}/range/1/day/2023-01-09/2023-01-09?adjusted=true&sort=asc&limit=120&apiKey=sF98gBtWzFtPZwy_lDORd2RSb4s08cIq`,{method:"GET"  //api link from pixaby
    }).then(res => res.json())
    .then(stock=>{
