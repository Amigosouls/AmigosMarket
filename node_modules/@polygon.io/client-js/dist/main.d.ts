...
declare type IRequestOptions = IRequestInit;
...
declare type ICurriedGet = (apiKey: string, apiBase: string, globalOptions?: IRequestOptions) => IGet;
...
declare type MarketType = "stocks" | "crypto" | "fx";
...
export { IAggegateForexEvent, IAggregateCryptoEvent, IAggregateIndexEvent, IAggregateStockEvent, IAggs, IAggsGroupedDaily, IAggsGroupedDailyQuery, IAggsPreviousClose, IAggsPreviousCloseQuery, IAggsQuery, IConditions, IConversion, IConversionQuery, ICryptoClient, ICryptoDailyOpenClose, ICryptoDailyOpenCloseQuery, ICryptoLastTrade, ICryptoSnapshot, ICryptoSnapshotAllTickersQuery, ICryptoSnapshotFullBookL2, ICryptoSnapshotTickers, ICryptoTrade, ICurriedGet, IDailyOpenClose, IDailyOpenCloseQuery, IDividendsResults, IEma, IExchanges, IForexClient, IForexLastQuote, IForexQuotes, IForexSnapshot, IForexSnapshotAllTickersQuery, IForexSnapshotTickers, IGet, IHeaders, IIndexValueEvent, IIndicesClient, ILastQuote, ILastTrade, ILevel2CryptoEvent, IMacd, IMarketHoliday, IMarketStatus, IOptionQuotes, IOptionTrades, IOptionsChainQuery, IOptionsClient, IOptionsDailyOpenClose, IOptionsDailyOpenCloseQuery, IOptionsLastTrade, IOptionsSnapshotChain, IOptionsSnapshotContract, IPolygonClient, IPolygonEdgeHeaders, IPolygonQuery, IPolygonQueryWithCredentials, IQuoteCryptoEvent, IQuoteForexEvent, IQuoteStockEvent, IQuotes, IRealTimeCurrencyConversion, IRealTimeCurrencyConversionQuery, IReferenceClient, IRequestInit, IRequestOptions, IRestClient, IRsi, ISma, ISnapshot, ISnapshotAllTickersQuery, ISnapshotTickers, IStockFinancialResults, IStockSplitsResults, IStocksClient, IStructuredError, ISummaries, ISummariesQuery, ITechnicalIndicatorsQuery, ITickerDetails, ITickerNews, ITickerNewsQuery, ITickerTypes, ITickerTypesQuery, ITickers, ITickersQuery, ITradeCryptoEvent, ITradeStockEvent, ITrades, ITradesQuotesQuery, IWebsocketClient, cryptoClient, polygonClient as default, forexClient, getCryptoWebsocket, getForexWebsocket, getIndicesWebsocket, getStocksWebsocket, getWithGlobals, indicesClient, optionsClient, polygonClient, referenceClient, restClient, snapshotOptionChain, snapshotOptionContract, stocksClient, websocketClient };
